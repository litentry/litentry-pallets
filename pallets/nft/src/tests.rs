...
fn test_claimed_token_process() {
	new_test_ext().execute_with(|| {
		...
		// root is 0x2e8d84521ed366fdaf1cb22073a1b1d1297a243b8e9cfbb789033239733a0b42
		let merkle_root = [
			0x2eu8, 0x8du8, 0x84u8, 0x52u8, 0x1eu8, 0xd3u8, 0x66u8, 0xfdu8, 0xafu8, 0x1cu8, 0xb2u8, 
			0x20u8, 0x73u8, 0xa1u8, 0xb1u8, 0xd1u8, 0x29u8, 0x7au8, 0x24u8, 0x3bu8, 0x8eu8, 0x9cu8, 
			0xfbu8, 0xb7u8, 0x89u8, 0x03u8, 0x32u8, 0x39u8, 0x73u8, 0x3au8, 0x0bu8, 0x42u8
		];

		// proof of alice is [0xb960a5bebfc4202529ce2283f885f95d8fa544e05357231da518fb3dce624694,
		//                    0xfed596b6e9b5a497ff3a9a41bad805224dfc77118718e60a3bca7cfdce27f31b]
		let alice_proof = vec![[
			0xb9u8, 0x60u8, 0xa5u8, 0xbeu8, 0xbfu8, 0xc4u8, 0x20u8, 0x25u8, 0x29u8, 0xceu8, 0x22u8, 
			0x83u8, 0xf8u8, 0x85u8, 0xf9u8, 0x5du8, 0x8fu8, 0xa5u8, 0x44u8, 0xe0u8, 0x53u8, 0x57u8, 
			0x23u8, 0x1du8, 0xa5u8, 0x18u8, 0xfbu8, 0x3du8, 0xceu8, 0x62u8, 0x46u8, 0x94u8
		],
		[
			0xfeu8, 0xd5u8, 0x96u8, 0xb6u8, 0xe9u8, 0xb5u8, 0xa4u8, 0x97u8, 0xffu8, 0x3au8, 0x9au8, 
			0x41u8, 0xbau8, 0xd8u8, 0x05u8, 0x22u8, 0x4du8, 0xfcu8, 0x77u8, 0x11u8, 0x87u8, 0x18u8, 
			0xe6u8, 0x0au8, 0x3bu8, 0xcau8, 0x7cu8, 0xfdu8, 0xceu8, 0x27u8, 0xf3u8, 0x1bu8
		]
		];
		...
		assert_ok!(Nft::claim(Origin::signed(alice_account.clone()), 2, 0, alice_proof.clone(),));
		assert_eq!(
			events_filter::<crate::Event::<Test>>()[2],
		...
		// alice claims again
		assert_noop!(
			Nft::claim(Origin::signed(alice_account.clone()), 2, 0, alice_proof,),
