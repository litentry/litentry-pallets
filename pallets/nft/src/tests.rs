...
fn test_issue_and_claim_eth() {
    new_test_ext().execute_with(|| {
        ...
        let merkle_root = vec![
            0xc6, 0x52, 0x9c, 0x59, 0x80, 0x8f, 0x77, 0x13, 0x5f, 0x28, 0xef, 0x70, 0xb6, 0x53,
            0x56, 0xdd, 0xd5, 0x83, 0xd9, 0x34, 0xda, 0x3d, 0xba, 0x95, 0xbc, 0xe2, 0x3f, 0x49,
            0xea, 0x27, 0x25, 0x8d,
        ];

        // proof of alice is 0x3fa539b400a4c2de2822425972ae67b752dea0cf1bc8f37a48143f84e72b1d19
        let alice_proof = vec![[
            0x3fu8, 0xa5u8, 0x39u8, 0xb4u8, 0x00u8, 0xa4u8, 0xc2u8, 0xdeu8, 0x28u8, 0x22u8, 0x42u8,
